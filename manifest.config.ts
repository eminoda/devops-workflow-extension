...
import { resolveExtensionVersionMeta } from './scripts/resolve-extension-version'

// version：Chrome 仅允许整数段；version_name：可展示 git tag（如 1.0.0-alpha.4）
const { version, versionName } = resolveExtensionVersionMeta()
